...
class StartPage(tk.Frame):
	def __init__(self,parent,controller):
		...
		label1=tk.Label(self,text="Student Attendance System",font=("Times",24))
...
class EditRecord(tk.Frame):
	def __init__(self,parent,controller):
		...
		lb2.pack()
		txt1.pack()
		lb3=tk.Label(self,text="Present Data",font=("Times",10))
		txt2=tk.Entry(self)
		lb4=tk.Label(self,text="Absent Data",font=("Times",10))
		txt3=tk.Entry(self)
		lb3.pack()
		txt2.pack()
		lb4.pack()
